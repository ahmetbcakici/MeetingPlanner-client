          ...
          <div className="columns">
            <div className="column has-text-centered">
              ...
              <p className="is-size-6 has-text-grey-light">
                ...
                meeting.Additionally different times(e.g.2 - 3 pm, 4 - 5 pm) can
                be specified for each day.
              </p>
            </div>
            <div className="column has-text-centered">
              <img
        ...
        <div className="container">
          ...
          <div className="columns">
            ...
            <div className="column">
              ...
              <p className="is-size-6 has-text-grey-light">
                Create as many polls as you want.Invite as many participants as
                you want.
              </p>
            </div>
            <div className="column is-1"> </div>
            <div className="column">
              ...
              <p className="is-size-6 has-text-grey-light">
                Publish your polls on a public personal page with a URL of your
                choice.
              </p>
            </div>
          </div>
          <div className="columns">
            <div className="column">
              ...
              <p className="is-size-6 has-text-grey-light">
                Collect additional information from your participants when they
                vote in your poll(e.g.their email address)
              </p>
            </div>
            <div className="column is-1"> </div>
            <div className="column">
          ...
          <div className="columns">
            ...
            <div className="column">
              <section className="section is-small">
                ...
                <p className="is-size-6 has-text-grey-light">
                  With opinion polls you and your participants can easily choose
                  the best option.
                </p>
                <div className="columns">
                  <div className="column is-12">
