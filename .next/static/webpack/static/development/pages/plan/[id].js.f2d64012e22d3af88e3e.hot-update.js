    ...
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function getPlan$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log('getplanbaş'); // setItemDetails(await axiosInstance.get('api', { params: { itemID: router.query.id } }));
          ...
          case 3:
            doc = _context.sent;
            _context.next = 6;
            return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(setItemDetails(doc.data));

          case 6:
            console.log('getplantest');
            console.log(itemDetails);
            console.log('getplanson');
...
//# sourceMappingURL=[id].js.f2d64012e22d3af88e3e.hot-update.js.map